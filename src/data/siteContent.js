...
export const siteContent = {
    ...
    workingLanes: [
      {
        ...
        titleZh: "企业门户与平台",
        leadEn: "Turn portal flows, permissions, routing, and micro-frontends into one usable platform.",
        leadZh: "把流程、权限、动态路由和微前端组织成一个可使用的企业平台。",
      ...
      },
      {
        ...
        titleZh: "AI 工作流",
        leadEn: "Bring agents, tool use, dynamic forms, and RAG into one business workflow.",
        leadZh: "把 Agent、工具调用、动态表单和 RAG 放进一条可执行的业务工作流。",
      ...
      },
      {
        ...
        titleZh: "从 0 到 1 交付",
        leadEn: "Carry a product from data expression and foundations to release and operations.",
        leadZh: "从数据表达、工程底座走到发布与运行，把项目完整交付。",
  ...
  coverage: {
    ...
    mapNotes: [
      ...
      { key: "typhoonEta", labelEn: "Typhoon / alerts", labelZh: "台风/预警", valueEn: "Typhoon alert source unavailable", valueZh: "台风预警源暂不可用" },
    ],
  },
  weather: {
    city: "Shenzhen",
